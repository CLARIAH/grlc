...
def swagger_spec(
    ...
    glogger.info(
        "-----> Generating swagger spec for /{}/{} ({}), subdir {}, params {}, on commit {}".format(
            user, repo, git_type, subdir, spec_url, sha
        )
    )

    swag = utils.build_swagger_spec(
        user, repo, subdir, spec_url, sha, static.SERVER_NAME, git_type, branch
    )
...
def query(
    ...
    glogger.info(
        "-----> Executing call name at /{}/{} ({})/{}/{} on commit {}".format(
            user, repo, git_type, subdir, query_name, sha
        )
    )
...
@app.route(
    "/api/local/local", methods=["GET"], strict_slashes=False
...
@app.route(
    "/api/local/local/swagger", methods=["GET"], strict_slashes=False
)  # backward compatibility route
...
@app.route(
    "/api/local/local/<query_name>", methods=["GET", "POST"], strict_slashes=False
)  # backward compatibility route
@app.route(
    "/api/local/local/<query_name>.<content>",
    methods=["GET", "POST"],
...
def query_param(query_name, content=None):
    ...
    return query(
        user=None, repo=None, query_name=query_name, spec_url=spec_url, content=content
    )
...
@app.route(
    "/api/<user>/<repo>/<path:subdir>", strict_slashes=False
)  # backward compatibility route
...
@app.route(
    "/api/<user>/<repo>/<path:subdir>/commit/<sha>"
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<path:subdir>/commit/<sha>/api-docs"
)  # backward compatibility route
...
@app.route(
    "/api/<user>/<repo>/swagger", methods=["GET"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<subdir>/swagger", methods=["GET"]
)  # backward compatibility route
@app.route("/api/<user>/<repo>/commit/<sha>/swagger")  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<subdir>/commit/<sha>/swagger"
)  # backward compatibility route
@app.route(
    "/api-git/<user>/<repo>/<path:subdir>/swagger", methods=["GET"]
)  # backward compatibility route
@app.route(
    "/api-git/<user>/<repo>/<path:subdir>/commit/<sha>/swagger"
)  # backward compatibility route
...
@app.route(
    "/api-git/<user>/<repo>/subdir/<path:subdir>/<query_name>", methods=["GET", "POST"]
)
@app.route("/api-git/<user>/<repo>/<query_name>.<content>", methods=["GET", "POST"])
@app.route(
    "/api-git/<user>/<repo>/subdir/<path:subdir>/<query_name>.<content>",
    methods=["GET", "POST"],
)
@app.route("/api-git/<user>/<repo>/commit/<sha>/<query_name>", methods=["GET", "POST"])
@app.route(
    "/api-git/<user>/<repo>/subdir/<path:subdir>/commit/<sha>/<query_name>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-git/<user>/<repo>/commit/<sha>/<query_name>.<content>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-git/<user>/<repo>/subdir/<path:subdir>/commit/<sha>/<query_name>.<content>",
    methods=["GET", "POST"],
)
@app.route(
    "/api/<user>/<repo>/<query_name>", methods=["GET", "POST"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<path:subdir>/<query_name>", methods=["GET", "POST"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<query_name>.<content>", methods=["GET", "POST"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<path:subdir>/<query_name>.<content>", methods=["GET", "POST"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/commit/<sha>/<query_name>", methods=["GET", "POST"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<path:subdir>/commit/<sha>/<query_name>",
    methods=["GET", "POST"],
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/commit/<sha>/<query_name>.<content>", methods=["GET", "POST"]
)  # backward compatibility route
@app.route(
    "/api/<user>/<repo>/<path:subdir>/commit/<sha>/<query_name>.<content>",
    methods=["GET", "POST"],
)  # backward compatibility route
...
@app.route(
    "/api-gitlab/<user>/<repo>/branch/<branch>/subdir/<path:subdir>",
    strict_slashes=False,
)
...
@app.route(
    "/api-gitlab/<user>/<repo>/branch/<branch>/subdir/<path:subdir>/swagger",
    methods=["GET"],
)
...
@app.route(
    "/api-gitlab/<user>/<repo>/query/branch/<branch>/<query_name>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/subdir/<path:subdir>/<query_name>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/branch/<branch>/subdir/<path:subdir>/<query_name>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/<query_name>.<content>", methods=["GET", "POST"]
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/subdir/<path:subdir>/<query_name>.<content>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/commit/<sha>/<query_name>", methods=["GET", "POST"]
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/subdir/<path:subdir>/commit/<sha>/<query_name>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/commit/<sha>/<query_name>.<content>",
    methods=["GET", "POST"],
)
@app.route(
    "/api-gitlab/<user>/<repo>/query/subdir/<path:subdir>/commit/<sha>/<query_name>.<content>",
    methods=["GET", "POST"],
)
def query_gitlab(
    user, repo, query_name, subdir=None, sha=None, content=None, branch=None
):
    """SPARQL query execution for specifications loaded from a Github repo."""
