...
static.GITHUB_ACCESS_TOKEN = (
    "fake-token"  # Manually overwrite access token to avoid empty token
)
...
def buildGHEntry(entryName):
    ...
    MockGithubContentFile = namedtuple(
        "MockGithubContentFile", "download_url name path type decoded_content"
    )
...
def buildGLEntry(entryName):
    ...
    return {"type": "blob", "name": entryName}
...
mock_simpleSparqlResponse = {
    ...
    "results": {
        "bindings": [
            {
                "p": {"type": "string", "value": "p1"},
                "o": {"type": "string", "value": "o1"},
            },
            {
                "p": {"type": "string", "value": "p2"},
                "o": {"type": "string", "value": "o2"},
            },
            {
                "p": {"type": "string", "value": "p3"},
                "o": {"type": "string", "value": "o3"},
            },
            {
                "p": {"type": "string", "value": "p4"},
                "o": {"type": "string", "value": "o4"},
            },
            {
                "p": {"type": "string", "value": "p5"},
                "o": {"type": "string", "value": "o5"},
            },
        ]
    },
}
